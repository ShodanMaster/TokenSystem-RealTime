    ...
    <div class="col-md-4">
        <div class="card text-dark bg-danger h-100">
            <div class="card-body d-flex flex-column text-center">
                ...
                <h2 class="fw-bold display-6 text-white">{{ $tokenAverage }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card text-dark bg-warning h-100">
            <div class="card-body d-flex flex-column text-center">
                ...
                <h2 class="fw-bold display-6 text-truncate text-white" style="max-width: 100%;">{{ $mostVisitedCounter ?? 'No Data' }}</h2>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card text-dark bg-success h-100">
            <div class="card-body d-flex flex-column text-center">
                ...
                <h2 class="fw-bold display-6 text-white">{{ $totalTokens ?? 'No Data' }}</h2>
            </div>
        </div>
    </div>
</div>
